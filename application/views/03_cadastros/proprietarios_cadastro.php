                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control celular" id="telefone_prop" name="telefone_prop" placeholder="Telefone do Proprietário">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="documento_prop">CPF/CNPJ</label>
                      <input type="text" class="form-control cpfcnpj" id="documento_prop" name="documento_prop" placeholder="CPF ou CNPJ">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control cep" id="cep_prop" name="cep_prop" placeholder="CEP do Proprietário">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="complemento_prop">Complemento</label>
                      <input type="text" class="form-control" id="complemento_prop" name="complemento_prop" placeholder="Complemento do Proprietário">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
